...
namespace TheOtherRoles.Objects {
    ...
    public class Portal {
        ...
        public static void startTeleport(byte playerId) {
            ...
            string playerNameDisplay = Portalmaker.logOnlyHasColors ? "一个 (" + (Helpers.isLighterColor(playerControl.Data.DefaultOutfit.ColorId) ? "浅色" : "深色") + ")" : playerControl.Data.PlayerName;
