...
namespace TheOtherRoles.Objects {
    ...
    public class Portal {
        ...
        public static void startTeleport(byte playerId) {
            ...
            string playerNameDisplay = Portalmaker.logOnlyHasColors ? "一个玩家 (" + (Helpers.isLighterColor(playerControl.Data.DefaultOutfit.ColorId) ? "浅" : "深") + ")" : playerControl.Data.PlayerName;
