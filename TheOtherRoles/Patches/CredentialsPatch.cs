...
$@"模组制作：<color=#FCCE03FF>JustASysAdmin</color>, 原版超多职业作者： <color=#FCCE03FF>Eisbison</color>. 其他图片:SvettyScribbles和JustASysAdmin.
汉化:<color=#ff351f>四个憨批汉化组</color> 翻译:Among us</size>";
