...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo undertaker = new RoleInfo("暗杀者", Undertaker.color, "杀光所有人，不留痕迹", "拖动尸体并隐藏起来", RoleId.Undertaker);
        ...
        public static RoleInfo cultist = new RoleInfo("崇拜者", Cultist.color, "为你的事业招兵买马", "为你的事业招兵买马", RoleId.Cultist);
