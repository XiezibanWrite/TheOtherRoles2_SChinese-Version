...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo lighter = new RoleInfo("执灯人", Lighter.color, "你的灯光永不熄灭", "你的灯光永不熄灭", RoleId.Lighter);
        ...
        public static RoleInfo trapper = new RoleInfo("陷阱师", Trapper.color, "放置陷阱来找到内鬼", "放置陷阱", RoleId.Trapper);
        ...
        public static RoleInfo pursuer = new RoleInfo("起诉人", Pursuer.color, "给内鬼塞空包弹", "给内鬼塞空包弹", RoleId.Pursuer);
        ...
        public static RoleInfo hunter = new RoleInfo("杀手", Palette.ImpostorRed, Helpers.cs(Palette.ImpostorRed, "寻找并杀死所有人"), "寻找并杀死所有人", RoleId.Impostor);
        public static RoleInfo hunted = new RoleInfo("躲藏者", Color.white, "隐藏", "隐藏", RoleId.Crewmate);
        ...
        public static RoleInfo shifter = new RoleInfo("交换师", Color.yellow, "交换你的职业", "交换你的职业", RoleId.Shifter, false, true);
