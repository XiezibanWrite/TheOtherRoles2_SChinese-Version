...
namespace TheOtherRoles.Modules {
    public class CustomColors {
        ...
        public static void Load() {
            ...
            /* Custom Colors */
            colors.Add(new CustomColor { longname = "璞玉色",
