...
namespace TheOtherRoles {
    public class CustomOption {
        ...
        public CustomOption(int id, CustomOptionType type, string name,  System.Object[] selections, System.Object defaultValue, CustomOption parent, bool isHeader) {
            ...
            selection = 0;
            if (id != 0) {
                entry = TheOtherRolesPlugin.Instance.Config.Bind($"配置{preset}", id.ToString(), defaultSelection);
        ...
        // Static behaviour
            ...
            foreach (CustomOption option in CustomOption.options) {
                ...
                option.entry = TheOtherRolesPlugin.Instance.Config.Bind($"配置{preset}", option.id.ToString(), option.defaultSelection);
    ...
    class GameOptionsDataPatch
    {
        ...
        private static string buildModifierExtras(CustomOption customOption) {
            ...
            var quantity = children.Where(o => o.name.Contains("数量")).ToList();
        ...
        private static void Postfix(ref string __result)
        {
            ...
            string hudString = counter != 0 ? Helpers.cs(DateTime.Now.Second % 2 == 0 ? Color.white : Color.red, "(如果有必要，请使用滚轮)\n\n") : "";
            int maxPage = 7;
            ...
            hudString += $"\n 按TAB键或页码数字查看更多... ({counter+1}/{maxPage})";
            __result = hudString;
        }
    }
